...
public:
  ...
  std::pair<YAML::Node, quoll::Entity> createNode(bool create = true) {
    ...
    if (create) {
      ...
      entity.set<quoll::Id>({id});

      return {node, entity};
    }

    return {node, quoll::Entity()};
  }
...
TEST_F(SceneLoaderNameTest, CreatesAutoGeneratedNameIfNameFieldIsNotDefined) {
  ...
  ASSERT_TRUE(entity.has<quoll::Name>());
  EXPECT_EQ(entity.get_ref<quoll::Name>()->name, untitledName);
}
...
TEST_F(SceneLoaderTransformTest, CreatesIdentityWorldTransform) {
  ...
  ASSERT_TRUE(entity.has<quoll::WorldTransform>());
...
TEST_F(SceneLoaderTransformTest,
  ...
  auto actual = entity.get_ref<quoll::LocalTransform>();
...
TEST_F(SceneLoaderSpriteTest, CreatesSpriteComponentWithFileDataIfValidField) {
  ...
  ASSERT_TRUE(entity.has<quoll::Sprite>());
  EXPECT_EQ(entity.get_ref<quoll::Sprite>()->handle, handle);
}
...
TEST_F(SceneLoaderMeshTest, CreatesMeshComponentIfValidAssetTypeIsMesh) {
  ...
  EXPECT_EQ(entity.get_ref<quoll::Mesh>()->handle, handle);
}
...
TEST_F(SceneLoaderMeshTest,
  ...
  EXPECT_FALSE(entity.has<quoll::Mesh>());
  EXPECT_EQ(entity.get_ref<quoll::SkinnedMesh>()->handle, handle);
}
...
TEST_F(SceneLoaderMeshRendererTest, DoesNotCreateComponentIfFieldIsNotDefined) {
  ...
  EXPECT_FALSE(entity.has<quoll::MeshRenderer>());
}
...
TEST_F(SceneLoaderMeshRendererTest, CreatesComponentWithMaterialsIfValid) {
  ...
  EXPECT_TRUE(entity.has<quoll::MeshRenderer>());
...
TEST_F(SceneLoaderSkinnedMeshRendererTest,
  ...
  EXPECT_FALSE(entity.has<quoll::SkinnedMeshRenderer>());
}
...
TEST_F(SceneLoaderSkinnedMeshRendererTest,
  ...
  EXPECT_TRUE(entity.has<quoll::SkinnedMeshRenderer>());
...
TEST_F(SceneLoaderSkeletonTest,
  ...
  ASSERT_TRUE(entity.has<quoll::Skeleton>());
...
TEST_F(SceneLoaderJointAttachmentTest,
  ...
  EXPECT_FALSE(entity.has<quoll::JointAttachment>());
}
...
TEST_F(SceneLoaderJointAttachmentTest,
  ...
  EXPECT_TRUE(entity.has<quoll::JointAttachment>());
  EXPECT_EQ(entity.get_ref<quoll::JointAttachment>()->joint, 20);
}

using SceneLoaderAnimatorTest = SceneLoaderTest;

TEST_F(SceneLoaderAnimatorTest,
       DoesNotCreateAnimatorComponentAnimatorFieldIsNotDefined) {
  auto [node, entity] = createNode();
...
TEST_F(SceneLoaderAnimatorTest,
       DoesNotCreateAnimatorComponentAnimatorFieldIsNotMap) {
  std::vector<YAML::Node> invalidNodes{
      YAML::Node(YAML::NodeType::Undefined), YAML::Node(YAML::NodeType::Null),
      YAML::Node(YAML::NodeType::Sequence), YAML::Node(YAML::NodeType::Scalar)};
...
TEST_F(SceneLoaderAnimatorTest,
       DoesNotCreateAnimatorComponentAssetFieldIsInvalid) {
  std::vector<YAML::Node> invalidNodes{
      YAML::Node(YAML::NodeType::Undefined), YAML::Node(YAML::NodeType::Null),
      YAML::Node(YAML::NodeType::Map), YAML::Node(YAML::NodeType::Sequence),
...
TEST_F(SceneLoaderAnimatorTest, CreatesAnimatorComponentAllFieldsAreValid) {
  ...
  ASSERT_TRUE(entity.has<quoll::Animator>());
...
TEST_F(SceneLoaderLightTest,
  ...
  EXPECT_FALSE(entity.has<quoll::DirectionalLight>());
}
...
TEST_F(SceneLoaderLightTest,
  ...
  for (const auto &invalidNode : invalidNodes) {
    ...
    ASSERT_TRUE(entity.has<quoll::DirectionalLight>());

    auto component = entity.get_ref<quoll::DirectionalLight>();
...
TEST_F(SceneLoaderLightTest,
  ...
  for (const auto &invalidNode : invalidNodes) {
    ...
    ASSERT_TRUE(entity.has<quoll::DirectionalLight>());
    ASSERT_TRUE(entity.has<quoll::CascadedShadowMap>());

    auto component = entity.get_ref<quoll::CascadedShadowMap>();
...
TEST_F(
  ...
  for (const auto &invalidNode : invalidNodes) {
    ...
    ASSERT_TRUE(entity.has<quoll::PointLight>());

    auto component = entity.get_ref<quoll::PointLight>();
...
TEST_F(SceneLoaderCameraTest,
  ...
  for (const auto &invalidNode : invalidNodes) {
    ...
    ASSERT_TRUE(entity.has<quoll::PerspectiveLens>());
    EXPECT_FALSE(entity.has<quoll::AutoAspectRatio>());

    auto component = entity.get_ref<quoll::PerspectiveLens>();
  ...
  for (const auto &invalidNode : invalidNodes) {
    ...
    ASSERT_TRUE(entity.has<quoll::PerspectiveLens>());
    ASSERT_TRUE(entity.has<quoll::AutoAspectRatio>());
...
TEST_F(SceneLoaderCameraTest, CreatesCameraComponentWithDefaultValues) {
  ...
  ASSERT_TRUE(entity.has<quoll::Camera>());
  auto component = entity.get_ref<quoll::Camera>();
...
TEST_F(SceneLoaderAudioTest, CreatesAudioComponentWithFileDataIfValidField) {
  ...
  ASSERT_TRUE(entity.has<quoll::AudioSource>());
  EXPECT_EQ(entity.get_ref<quoll::AudioSource>()->source, handle);
}
...
TEST_F(SceneLoaderScriptTest,
  ...
  EXPECT_EQ(entity.get_ref<quoll::LuaScript>()->handle, handle);
}
...
TEST_F(SceneLoaderScriptTest,
  ...
  for (const auto &invalidNode : invalidNodes) {
    ...
    sceneLoader.loadComponents(node, entity, entityIdCache).getData();
    ASSERT_TRUE(entity.has<quoll::Text>());
    auto text = entity.get_ref<quoll::Text>();
...
TEST_F(SceneLoaderRigidBodyTest,
  ...
  for (const auto &invalidNode : invalidNodes) {
    ...
    sceneLoader.loadComponents(node, entity, entityIdCache).getData();
    ASSERT_TRUE(entity.has<quoll::RigidBody>());
    auto rigidBody = entity.get_ref<quoll::RigidBody>();
...
TEST_F(SceneLoaderCollidableTest,
  ...
  for (const auto &invalidNode : invalidNodes) {
    ...
    ASSERT_TRUE(entity.has<quoll::Collidable>());
    const auto &center =
        entity.get_ref<quoll::Collidable>()->geometryDesc.center;
...
TEST_F(SceneLoaderCollidableTest, SetsCenterToProvidedCenterFieldIfValid) {
  ...
  ASSERT_TRUE(entity.has<quoll::Collidable>());
  const auto &center = entity.get_ref<quoll::Collidable>()->geometryDesc.center;
...
TEST_F(SceneLoaderCollidableTest,
  ...
  for (const auto &invalidNode : invalidNodes) {
    ...
    ASSERT_TRUE(entity.has<quoll::Collidable>());
    const auto &material = entity.get_ref<quoll::Collidable>()->materialDesc;
...
TEST_F(SceneLoaderCollidableTest, SetsCollidableModesToTrueIfInvalidField) {
  ...
  for (const auto &invalidNode : invalidNodes) {
    ...
    ASSERT_TRUE(entity.has<quoll::Collidable>());
    EXPECT_TRUE(entity.get_ref<quoll::Collidable>()->useInSimulation);
    EXPECT_TRUE(entity.get_ref<quoll::Collidable>()->useInQueries);
  }
}
...
TEST_F(SceneLoaderCollidableTest, SetsCollidableModesToDataInFileIfValid) {
  {
    ...
    ASSERT_TRUE(entity.has<quoll::Collidable>());
    EXPECT_FALSE(entity.get_ref<quoll::Collidable>()->useInSimulation);
    EXPECT_FALSE(entity.get_ref<quoll::Collidable>()->useInQueries);
  }
...
TEST_F(SceneLoaderParentTest,
  ...
  EXPECT_FALSE(entity.has<quoll::Parent>());
  EXPECT_FALSE(parentEntity.has<quoll::Children>());
}
...
TEST_F(SceneLoaderParentTest,
  ...
  auto parentEntity = entityDatabase.entity();
  parentEntity.set<quoll::Id>({ParentId});
...
TEST_F(SceneLoaderParentTest, CreatesParentComponentIfParentEntityExists) {
  ...
  ASSERT_TRUE(entity.has<quoll::Parent>());
  EXPECT_EQ(entity.get_ref<quoll::Parent>()->parent, parentEntity);
  ASSERT_TRUE(parentEntity.has<quoll::Children>());
  EXPECT_EQ(parentEntity.get_ref<quoll::Children>()->children.at(0), entity);
}

TEST_F(SceneLoaderParentTest,
       AddsChildToParentComponentIfChildrenComponentAlreadyExists) {
  auto [parentNode, parentEntity] = createNode();
  parentEntity.set<quoll::Children>({{quoll::Entity()}});
  ...
  EXPECT_EQ(entity.get_ref<quoll::Parent>()->parent, parentEntity);
  ASSERT_TRUE(parentEntity.has<quoll::Children>());
  EXPECT_EQ(parentEntity.get_ref<quoll::Children>()->children.at(1), entity);
}
...
TEST_F(SceneLoaderActiveCameraTest,
  ...
  startingCameraNode.second.set<quoll::PerspectiveLens>({});

  auto camera1 = createNode(true).second;
  camera1.set<quoll::PerspectiveLens>({});

  auto camera2 = createNode(true).second;
  camera2.set<quoll::PerspectiveLens>({});
...
TEST_F(SceneLoaderSkyboxTest, DoesNotAddSkyboxIfNoSkyboxField) {
  ...
  EXPECT_FALSE(entity.has<quoll::EnvironmentSkybox>());
}
...
TEST_F(SceneLoaderSkyboxTest,
  ...
  sceneLoader.loadComponents(node, entity, entityIdCache).getData();
  ASSERT_TRUE(entity.has<quoll::EnvironmentSkybox>());
  auto component = entity.get_ref<quoll::EnvironmentSkybox>();
...
TEST_F(SceneLoaderEnvironmentLightingTest,
  ...
  EXPECT_FALSE(entity.has<quoll::EnvironmentLightingSkyboxSource>());
}
...
TEST_F(SceneLoaderEnvironmentLightingTest,
  ...
  sceneLoader.loadComponents(node, entity, entityIdCache).getData();
  EXPECT_TRUE(entity.has<quoll::EnvironmentLightingSkyboxSource>());
}
...
TEST_F(SceneLoaderInputMapTest,
  ...
  EXPECT_FALSE(entity.has<quoll::InputMapAssetRef>());
}
...
TEST_F(SceneLoaderInputMapTest, CreatesInputMapComponentIfInputMapAssetExists) {
  ...
  ASSERT_TRUE(entity.has<quoll::InputMapAssetRef>());
  EXPECT_EQ(entity.get_ref<quoll::InputMapAssetRef>()->handle, handle);
  EXPECT_EQ(entity.get_ref<quoll::InputMapAssetRef>()->defaultScheme, 1);
}
...
TEST_F(SceneLoaderInputMapTest, SetsInputMapDefaultSchemeToZeroIfInvalidField) {
  ...
  for (auto invalidNode : invalidNodes) {
    ...
    ASSERT_TRUE(entity.has<quoll::InputMapAssetRef>());
    EXPECT_EQ(entity.get_ref<quoll::InputMapAssetRef>()->defaultScheme, 0);
  }
}
...
TEST_F(SceneLoaderUICanvasTest, DoesNotAddUICanvasComponentIfNoUICanvasField) {
  auto [node, entity] = createNode();
  sceneLoader.loadComponents(node, entity, entityIdCache).getData();
  EXPECT_FALSE(entity.has<quoll::UICanvas>());
}
...
TEST_F(SceneLoaderUICanvasTest,
  ...
  sceneLoader.loadComponents(node, entity, entityIdCache).getData();
  EXPECT_TRUE(entity.has<quoll::UICanvas>());
}
