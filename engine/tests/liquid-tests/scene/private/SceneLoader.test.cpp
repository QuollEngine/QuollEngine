...
public:
  ...
  std::pair<YAML::Node, liquid::Entity> createNode(bool createEntity = true) {
    auto id = lastId++;
    ...
    if (createEntity) {
      ...
      entityDatabase.setComponent<liquid::IdComponent>(entity, {id});
...
TEST_F(SceneLoaderTransformTest, CreatesIdentityWorldTransform) {
  ...
  EXPECT_TRUE(
      entityDatabase.hasComponent<liquid::WorldTransformComponent>(entity));
...
TEST_F(SceneLoaderMeshTest, DoesNotCreateMeshComponentIfMeshFieldIsNotDefined) {
  ...
  EXPECT_FALSE(entityDatabase.hasComponent<liquid::MeshComponent>(entity));
}
...
TEST_F(SceneLoaderMeshTest, CreatesMeshComponentWithFileDataIfValidField) {
  ...
  EXPECT_TRUE(entityDatabase.hasComponent<liquid::MeshComponent>(entity));
  EXPECT_EQ(entityDatabase.getComponent<liquid::MeshComponent>(entity).handle,
            handle);
}
...
TEST_F(SceneLoaderMeshTest,
  ...
  EXPECT_FALSE(
      entityDatabase.hasComponent<liquid::SkinnedMeshComponent>(entity));
}
...
TEST_F(SceneLoaderMeshTest,
  ...
  EXPECT_TRUE(
      entityDatabase.hasComponent<liquid::SkinnedMeshComponent>(entity));
  EXPECT_EQ(
      entityDatabase.getComponent<liquid::SkinnedMeshComponent>(entity).handle,
      handle);
}
...
TEST_F(SceneLoaderSkeletonTest,
  ...
  EXPECT_FALSE(entityDatabase.hasComponent<liquid::SkeletonComponent>(entity));
}
...
TEST_F(SceneLoaderSkeletonTest,
  ...
  for (const auto &invalidNode : invalidNodes) {
    ...
    sceneLoader.loadComponents(node, entity, entityIdCache).getData();
    EXPECT_FALSE(
        entityDatabase.hasComponent<liquid::SkeletonComponent>(entity));
  }
}
...
TEST_F(SceneLoaderSkeletonTest,
  ...
  EXPECT_TRUE(entityDatabase.hasComponent<liquid::SkeletonComponent>(entity));
...
TEST_F(SceneLoaderLightTest,
  ...
  EXPECT_FALSE(
      entityDatabase.hasComponent<liquid::DirectionalLightComponent>(entity));
}
...
TEST_F(SceneLoaderCameraTest,
  ...
  EXPECT_FALSE(entityDatabase.hasComponent<liquid::CameraComponent>(entity));
  EXPECT_FALSE(
      entityDatabase.hasComponent<liquid::PerspectiveLensComponent>(entity));
  EXPECT_FALSE(
      entityDatabase.hasComponent<liquid::AutoAspectRatioComponent>(entity));
}
...
TEST_F(SceneLoaderCameraTest, CreatesCameraComponentWithDefaultValues) {
  ...
  EXPECT_TRUE(entityDatabase.hasComponent<liquid::CameraComponent>(entity));
  const auto &component =
      entityDatabase.getComponent<liquid::CameraComponent>(entity);
...
TEST_F(SceneLoaderAudioTest, CreatesAudioComponentWithFileDataIfValidField) {
  ...
  EXPECT_TRUE(
      entityDatabase.hasComponent<liquid::AudioSourceComponent>(entity));
  EXPECT_EQ(
      entityDatabase.getComponent<liquid::AudioSourceComponent>(entity).source,
      handle);
}
...
TEST_F(SceneLoaderScriptTest,
  ...
  EXPECT_FALSE(entityDatabase.hasComponent<liquid::ScriptingComponent>(entity));
}
...
TEST_F(SceneLoaderScriptTest,
  ...
  for (const auto &invalidNode : invalidNodes) {
    ...
    sceneLoader.loadComponents(node, entity, entityIdCache).getData();
    EXPECT_FALSE(
        entityDatabase.hasComponent<liquid::ScriptingComponent>(entity));
  }
}
...
TEST_F(SceneLoaderScriptTest, CreatesScriptComponentWithFileDataIfValidField) {
  ...
  EXPECT_TRUE(entityDatabase.hasComponent<liquid::ScriptingComponent>(entity));
  EXPECT_EQ(
      entityDatabase.getComponent<liquid::ScriptingComponent>(entity).handle,
      handle);
}
...
TEST_F(SceneLoaderScriptTest,
  ...
  for (const auto &invalidNode : invalidNodes) {
    ...
    sceneLoader.loadComponents(node, entity, entityIdCache).getData();
    EXPECT_TRUE(entityDatabase.hasComponent<liquid::TextComponent>(entity));
    const auto &text =
        entityDatabase.getComponent<liquid::TextComponent>(entity);
...
TEST_F(SceneLoaderTextTest, CreatesTextComponentWithFileDataIfValidField) {
  ...
  EXPECT_TRUE(entityDatabase.hasComponent<liquid::TextComponent>(entity));
  const auto &text = entityDatabase.getComponent<liquid::TextComponent>(entity);
...
TEST_F(SceneLoaderParentTest,
  ...
  EXPECT_FALSE(entityDatabase.hasComponent<liquid::ParentComponent>(entity));
  EXPECT_FALSE(
      entityDatabase.hasComponent<liquid::ChildrenComponent>(parentEntity));
}
...
TEST_F(SceneLoaderParentTest, CreatesParentComponentIfParentEntityExists) {
  ...
  EXPECT_TRUE(entityDatabase.hasComponent<liquid::ParentComponent>(entity));
  EXPECT_EQ(entityDatabase.getComponent<liquid::ParentComponent>(entity).parent,
            parentEntity);
  EXPECT_TRUE(
      entityDatabase.hasComponent<liquid::ChildrenComponent>(parentEntity));
  EXPECT_EQ(entityDatabase.getComponent<liquid::ChildrenComponent>(parentEntity)
                .children.at(0),
            entity);
}
...
TEST_F(SceneLoaderParentTest,
  ...
  entityDatabase.setComponent<liquid::ChildrenComponent>(
      parentEntity, {{liquid::EntityNull}});
